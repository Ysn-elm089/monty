 ...
 */
void add_to__stack(stack_t **new_node, __attribute__((unused))unsigned int ln)
{
	stack_t *tmp;
...
/**
 * print_stack -  prints all the values on the stack, starting from the top of the stack
